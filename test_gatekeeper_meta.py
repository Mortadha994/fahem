...
Two parts, like the other gatekeeper script:
  ...
  --live           - the four real messages from the transcript, in order,
                     ...
                     Groq quota, same as test_gatekeeper_adversarial.py).

Run inside the backend container:
    docker compose exec -T backend python test_gatekeeper_meta.py [--live]
"""
...
def offline() -> None:
    ...
    # The niveau api.py passes: the student's own class when they have set it.
    import api
