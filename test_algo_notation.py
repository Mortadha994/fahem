"""Tests for algo_notation.py: Python operators never reach the Algorithme
column, and nothing else is touched. Pure functions - no services.

    docker compose exec -T backend python test_algo_notation.py
"""

from __future__ import annotations

import checker
from algo_notation import normalize_answer, to_algo_notation
