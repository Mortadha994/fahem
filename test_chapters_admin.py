...
Inside compose (needs the embedding model, Postgres, Qdrant):
    ...
    docker compose exec backend python test_chapters_admin.py
...
import auth
import chapter_store as cs
from db import session_scope
from models import ROLE_ADMIN, UploadedChapter, User
...
def main() -> None:
    ...
    import chapters
    from context import PinResolutionError, build_context, published_pins
...
def markdown_flow(client, as_user, admin_id, student_id) -> None:
    from context import build_context, published_pins
