...
app/grading/checker.py, imported below for main()'s end-to-end run. Nothing about its
...
# working unchanged - app/llm/llm_stream.py does `from generate import GROQ_MODEL,
# GROQ_URL`, and load_env is imported from here by app/llm/gatekeeper.py.
