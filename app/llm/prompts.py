...
retrieval scope keys are normalised separately in app/rag/retrieval.py, so they can
...
def build_messages(
    ...
    app/llm/generate.py and existing callers are unchanged), QUESTION or CODE.
