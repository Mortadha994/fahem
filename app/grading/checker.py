...
Extracted verbatim from app/llm/generate.py, which was doing three unrelated jobs
...
one exists. app/llm/generate.py now imports check_constraints from here.
