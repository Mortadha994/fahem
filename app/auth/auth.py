...
from app.core import ratelimit as _ratelimit
...
from app.core.models import NIVEAUX, ROLE_ADMIN, SECTIONS_BY_NIVEAU, User
...
def upsert_user(claims: dict) -> User:
    ...
    keying on it would orphan the user's history after a rename (app/core/models.py
...
def get_current_admin(user: User = Depends(get_current_user)) -> User:
    ...
    no write path in this phase - scripts/promote_admin.py is the only way in or out of
...
def bind_user(
    ...
    Lives here rather than in app/core/ratelimit.py because app/core/ratelimit.py must not
    import this module - app/auth/auth.py imports it for the /auth/google decorator,
