...
from app.core.config import RATE_LIMIT_RETRY_AFTER_FALLBACK, REDIS_URL, TRUSTED_CLIENT_IP_HEADER

# This module deliberately does NOT import auth. app/auth/auth.py imports it (for the
...
# lives in app/auth/auth.py as bind_user() - the identity half is an auth concern
