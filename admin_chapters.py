...
Same rule as admin.py: get_current_admin is declared once on the router, and
test_chapters_admin.py asserts every route inherits it.
...
from config import MAX_CHAPTER_PDF_BYTES
