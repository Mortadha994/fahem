...
Follows tests/test_retrieval.py / tests/test_gatekeeper_adversarial.py's main() +
__main__ guard shape rather than tests/test_checker.py's run-at-import shape, so
