"""Tests for session memory (app/grading/session_memory.py and where it is wired in).
...
from app.grading import session_memory as sm
...
def live() -> None:
    ...
    from app.llm.generate import call_groq
