"""Adversarial transcript script for app/llm/gatekeeper.py.

Calls classify()/respond_meta() directly - no FastAPI, no HTTP round-trip -
same "hit the module functions directly" pattern app/llm/generate.py's own main()
...
from app.llm import gatekeeper
