...
Follows tests/test_db.py's main() + __main__ shape (importing this module must not
...
def password_accounts(run_id: str) -> None:
    ...
    from app.auth import password_auth as pa
    from app.core import ratelimit
    from app.core.config import REDIS_URL
    from app.core.models import AuthToken

    # A private app with exactly the production auth wiring (app/main.py's lines),
    # without importing app/main.py - which would load the embedding model.
    app = FastAPI()
